...
(function (factory) {
    ...
    $.fn.rating.defaults = {
        ...
        showCaption: true,
        starCaptionClasses: {
            0.5: 'label label-light badge-light',
            1: 'label label-secondary badge-secondary',
            1.5: 'label label-secondary badge-secondary',
            2: 'label label-info badge-info',
            2.5: 'label label-info badge-info',
            3: 'label label-success badge-success',
            3.5: 'label label-success badge-success',
            4: 'label label-warning badge-warning text-white',
            4.5: 'label label-warning badge-warning text-white',
            5: 'label label-danger badge-danger'
        },
        clearButton: '<i class="glyphicon glyphicon-minus-sign"></i>',
        clearButtonBaseClass: 'clear-rating',
        clearButtonActiveClass: 'clear-rating-active',
        clearCaptionClass: 'label label-light badge-light',
        clearValue: null,
        captionElement: null,
        clearElement: null,
